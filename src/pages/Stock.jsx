...
export const Stock = ({ title = "Listado de Stock" }) => {
  ...
  const onPuntoGiroClick = (id) => {
    ...
    setActiveButton(id);
    localStorage.setItem("lastSelectedSucursalId", id);
  };
  ...
  useEffect(() => {
    ...
    const lastSelectedId = localStorage.getItem("lastSelectedSucursalId");
    const specificSucursalId = lastSelectedId || 2;
    onPuntoGiroClick(Number(specificSucursalId));
  }, []);
