...
export const WarningModal = ({
  ...
  return (
    <>
      ...
      >
        {btnIcon && <Icons icon={`heroicons:${btnIcon}`} /> }
        {label}
      </button>
                ...
                >
                  ...
                  >
                    ...
                    <div className="flex justify-center gap-4">
                        <button className="btn inline-flex justify-center btn-danger px-12" disabled={disabled} onClick={ closeModal }>Cancelar</button>
                        <button className="btn inline-flex justify-center btn-success px-12" disabled={disabled} onClick={ aprobarEntrega }>{ labelBtn }</button>
                    </div>
                  </div>
                  {footerContent && (
